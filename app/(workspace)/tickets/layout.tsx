  ...
  return (
    <div>
      <header>
        ...
        <button className="flex items-center gap-2 justify-center px-2 md:px-4 py-2.5 cursor-pointer bg-emerald-600 dark:bg-emerald-500 rounded-lg text-sm font-medium text-white hover:bg-emerald-700 dark:hover:bg-emerald-600 transition-colors shadow-sm">
          Add Ticket
          <Plus size={16} />
        </button>
          </div>
